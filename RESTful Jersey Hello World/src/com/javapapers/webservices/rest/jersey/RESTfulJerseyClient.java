...
public class RESTfulJerseyClient {
	...
	public static void main(String[] args) {
		...
		// response
		System.out.println(webTarget.path("rest").path("helloworld").request().acceptLanguage(MediaType.TEXT_PLAIN).get(Response.class).toString());
				

		// text
		System.out.println(webTarget.path("rest").path("helloworld").request()
				.acceptLanguage(MediaType.TEXT_PLAIN).get(String.class));

		// xml
		System.out.println(webTarget.path("rest").path("helloworld").request()
				.acceptLanguage(MediaType.TEXT_XML).get(String.class));

		// html
		System.out.println(webTarget.path("rest").path("helloworld").request()
				.acceptLanguage(MediaType.TEXT_HTML).get(String.class));
	}
}
